...
#if defined (__CC_ARM)
#define IMAGE1_VALID_PATTEN_SECTION    SECTION(".image1.validate.rodata") __attribute__((used))
#define IMAGE2_VALID_PATTEN_SECTION    SECTION(".image2.validate.rodata") __attribute__((used))
#else
...
#if defined (__CC_ARM)
#define IMAGE2_START_RAM_FUN_SECTION   SECTION(".image2.ram.data") __attribute__((used))
#else

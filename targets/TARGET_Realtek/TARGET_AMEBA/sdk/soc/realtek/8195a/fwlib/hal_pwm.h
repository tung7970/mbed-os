...
/* the minimum tick time for G-timer is 61 us
 *    (clock source = 32768Hz, reload value=1 and reload takes extra 1T)
 */
#define MIN_GTIMER_TIMEOUT     61
#define PWM_GTIMER_TICK_TIME   61

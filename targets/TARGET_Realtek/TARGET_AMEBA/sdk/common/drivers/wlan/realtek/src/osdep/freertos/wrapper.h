...
#        define MAX_RX_PKT_LIMIT       \
               ((WLAN_MAX_PROTOCOL_OVERHEAD + WLAN_MAX_RX_ETHFRM_LEN + 511) / 512) // 4, for lxbus
#      else
#        define MAX_RX_PKT_LIMIT       \
               ((WLAN_MAX_PROTOCOL_OVERHEAD + WLAN_MAX_ETHFRM_LEN + 511) / 512) // 4, for lxbus
#      endif
...
#      else
#        define MAX_RX_PKT_SIZE        \
               WLAN_MAX_PROTOCOL_OVERHEAD + WLAN_MAX_ETHFRM_LEN // MAX_RX_PKT_SIZE = 64+1514 = 1578
#      endif
#      define MAX_RX_PKT_LIMIT         \

...
extern uint8_t Image$$RW_DTCM1$$ZI$$Base[];
extern uint8_t Image$$RW_DTCM1$$ZI$$Limit[];
extern uint8_t Image$$RW_DRAM1$$ZI$$Base[];
extern uint8_t Image$$RW_DRAM1$$ZI$$Limit[];
#define __bss_sram_start__ Image$$RW_IRAM1$$ZI$$Base
#define __bss_sram_end__   Image$$RW_IRAM1$$ZI$$Limit
#define __bss_dtcm_start__ Image$$RW_DTCM1$$ZI$$Base
#define __bss_dtcm_end__   Image$$RW_DTCM1$$ZI$$Limit
#define __bss_dram_start__ Image$$RW_DRAM1$$ZI$$Base
#define __bss_dram_end__   Image$$RW_DRAM1$$ZI$$Limit
